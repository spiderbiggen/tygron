...
public class ContextEnv extends EisEnv {
	 ...
	 */
	@Override
	protected Percept performEntityAction(final String ent, final Action action)
			throws ActException {
		try {
	 ...
	 */
	@Override
	public TygronEntity createNewEntity(final EntityListener listener, final String stakeholder,
										final Integer slot) {
