...
public class ConnectorTest {
	...
	public void createConnector() {
		...
		Mockito.when(connection.execute(Mockito.eq("services/myuser"), Mockito.eq(CallType.GET),
				Mockito.any(JsonObjectResultHandler.class))).thenReturn(new JSONObject(myUserString));
