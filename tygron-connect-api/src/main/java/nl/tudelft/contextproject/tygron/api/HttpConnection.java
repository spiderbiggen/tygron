...
public class HttpConnection {
	...
	private static final String API_URL_BASE = "https://preview.tygron.com/api/";
	 ...
	 *            A type
	 * @param eventName
	 *            The event name, a part of the URL
	 * @param type
	 *            GET or POST event
	 * @param resultHandler
	 *            The handler used to parse Tygron's result.
	 * @param isSession
	 *            If this is a call to the session or regular API.
	 * @param parameters
	 *            The parameters this request should use, can be null
	 ...
	 *            If this is a call to the session or regular API.
	 * @param parameters
	 *            The parameters this request should use
	 ...
	 * @param isSession
	 *            Whether this is a call to the session part of the API.
	 ...
	 * 
	 * @param request
	 *            the request to attach the headers to
	 */
	/**
	 * Adds the required headers (authentication) for Tygron communication.
	 * 
