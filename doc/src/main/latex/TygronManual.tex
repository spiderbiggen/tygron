...
The saved password expires after a week. After expiration, the SDK login will fail with an LoginException "Failed to connect with \textless user\textgreater". You can fix this by resetting your password manually as explained in the next section. 
