...
import nl.tytech.data.engine.item.CustomIndicator;
import nl.tytech.data.engine.serializable.MapType;

public class J2CustomIndicator implements Java2Parameter<CustomIndicator> {
	
	private final Translator translator = Translator.getInstance();
	
	@Override
	public Parameter[] translate(CustomIndicator o) throws TranslationException {
	...
	@Override
	public Class<? extends CustomIndicator> translatesFrom() {
